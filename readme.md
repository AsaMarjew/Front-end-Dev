...
- [x] bevat 2 verschillende pagina’s
...
- [x] ziet er goed uit en werkt goed op telefoons (oude iPhone SE tot Galaxy Note)
- [x] is volledig responsive óf heeft een extra verzorgde surface plane
